...
/**
 * die Klasse wird verwendet um das Spielfeld zusammenzubauen
 */
public class Level {
    private TileSet[] ts;
    ...
    /**
     * Der long String von der loadFileAsString() Method aus der Klasse Utils wird in ein 1 dimensionales Array konvertiert, 
     * danach werden diese Zahlen in ein 2 dimensionlaes Array umgewandelt (tileMap)
     */
    public Level(Game game, String[] path, TileSet[] ts) {
        ...
        for(int z = 0; z < ts.length; z++) {
            int i = 2; // ein OFFset wird kreirt, da die ersten beiden zahlen in der Spielfeld Datei nicht zum 
            //eigentlichen Speilfeld gehören
